            ...
            <div class="layui-row maginTop">
                <form class="layui-form layui-col-md12 x-so">
                    <div class="layui-inline layui-show-xs-block">
                        ...
                        <input class="layui-input search-input" type="text" autocomplete="off" placeholder="选择日期"
                               id="chooseDate">
                    </div>
                                ...
                                success: function (msg) {
                                    ...
                                    table.render({
                                        ...
                                        cols: [[
                                            ...
                                            , {
                                                title: weekList[0] + ' 星期一',
                                                field: "monday",
                                                width: '140',
                                                toolbar: '#monday'
                                            }
                                            , {
                                                title: weekList[1] + ' 星期二',
                                                field: "tuesday",
                                                width: '140',
                                                toolbar: '#tuesday'
                                            }
                                            , {
                                                title: weekList[2] + ' 星期三',
                                                field: "wednesday",
                                                width: '140',
                                                toolbar: '#wednesday'
                                            }
                                            , {
                                                title: weekList[3] + ' 星期四',
                                                field: "thursday",
                                                width: '140',
                                                toolbar: '#thursday'
                                            }
                                            , {
                                                title: weekList[4] + ' 星期五',
                                                field: "friday",
                                                width: '140',
                                                toolbar: '#friday'
                                            }
                                            , {
                                                title: weekList[5] + ' 星期六',
                                                field: "saturday",
                                                width: '140',
                                                toolbar: '#saturday'
                                            }
                                            , {
                                                title: weekList[6] + ' 星期日',
                                                field: "sunday",
                                                width: '140',
                                                toolbar: '#sunday'
                                            }
